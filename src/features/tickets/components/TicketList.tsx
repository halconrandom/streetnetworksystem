    ...
    <div className="p-6 md:p-8 h-full flex flex-col">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between mb-6 gap-4">
        ...
        <div className="flex items-center gap-2">
          ...
          <button className="p-2 bg-terminal-panel border border-terminal-border rounded-md text-terminal-muted hover:text-white" onClick={loadTickets} title="Refresh" type="button">
            <RotateCcw size={16} />
          </button>
            ...
            {tickets.map((t) => (
              <tr key={t.id} onClick={() => onSelectTicket(t.id)} className="hover:bg-white/5 cursor-pointer transition-colors group">
                ...
                <td className="px-6 py-4 text-right">
                  <button className="text-terminal-muted hover:text-white">
