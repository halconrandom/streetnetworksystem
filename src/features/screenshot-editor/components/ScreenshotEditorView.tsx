...
export const ScreenshotEditorView: React.FC<ScreenshotEditorViewProps> = ({ userFlags }) => {
  ...
  return (
    <DndProvider backend={HTML5Backend}>
      <div className="p-0 h-full min-h-0 flex flex-col bg-[#f4f1ea] animate-fade-in overflow-hidden">
        {/* GLOBAL TOP BAR */}
        {!activeCropOverlayId && (
          <TopBar
            canUndo={canUndo}
        ...
        <div className="flex-1 min-h-0 flex relative overflow-hidden">
          ...
          {/* MAIN VIEWPORT */}
          <div className="flex-1 min-h-0 min-w-0 flex flex-col relative bg-[#f4f1ea]">
            {activeCropOverlayId ? (
