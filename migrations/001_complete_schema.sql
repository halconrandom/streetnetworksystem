-- Migration: Complete Auth Schema with Clerk + Discord
-- Creates all necessary tables for authentication with Clerk and Discord OAuth
...
-- ============================================
-- SESSIONS TABLE (Legacy - may not be used with Clerk)
-- ============================================
