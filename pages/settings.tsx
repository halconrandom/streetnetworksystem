  ...
  return (
    <div className="space-y-6">
      <div className="neo-panel p-5 bg-yellow-300 flex items-center gap-3">
        ...
        <div>
          <h1 className="text-2xl font-display font-bold text-black">Settings</h1>
          <p className="text-sm font-sans font-medium text-slate-700">Configuración general de la plataforma</p>
        </div>
      </div>

      <div className="neo-panel p-12 text-center bg-yellow-300">
        <h2 className="text-2xl font-display font-bold text-black uppercase mb-3">SETTINGS MODULE</h2>
